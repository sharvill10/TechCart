...
import { ShoppingBag, MapPin, CreditCard, ArrowRight, AlertTriangle, Package } from 'lucide-react';
                      ...
                      <div key={index} className="flex justify-between items-center border-b border-gray-200 pb-3 last:border-0 last:pb-0">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">{item.qty} × ₹{item.price} = ₹{item.qty * item.price}</p>
                          </div>
                        </div>
                      </div>
                    ))
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-100 mt-6">
                ...
                <p className="text-sm text-blue-700">
                  Your order will be processed within 24 hours and delivery typically takes 3-5 business days.
                </p>
              </div>
            </div>
          </div>
