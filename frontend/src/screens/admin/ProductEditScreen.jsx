...
import { ArrowLeft, Package, DollarSign, Image, Tag, Layers, FileText, Upload, Loader2 } from 'lucide-react';

// Enhanced Loader component
const Loader = () => (
  <div className="flex justify-center items-center py-12">
    <div className="animate-spin h-10 w-10 border-4 border-blue-600 border-t-transparent rounded-full"></div>
    <span className="ml-3 text-gray-600 font-medium">Loading product data...</span>
  </div>
);
      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        {isLoading ? (
          ...
          <Message variant="danger">
            {error?.data?.message || error.error || 'An error occurred while fetching product data'}
          </Message>
        ) : (
          <div className="p-6">
